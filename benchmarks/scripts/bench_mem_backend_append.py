...
def main():
    parser = argparse.ArgumentParser(description="Append kvstore benchmark results to a cumulative CSV.")
    ...
    parser.add_argument("--plot", action="store_true", help="invoke plot_bench_grouped.py after appending")
