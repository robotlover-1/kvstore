...
**跨机 kprobe（2026-07-01 重测，10K 请求，kernel 6.1.176，共用 fd + null trim）**
...
> 跨机 kprobe QPS（~21-32K）高于本地（~17-20K），因本地测试包含 slave_thread 额外开销。跨机 slave 端使用 `nc -l 15801` 简单接收，仅计数字节。
