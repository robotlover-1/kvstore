...
**跨机三模式对比（2026-07-01 重测，10K，kernel 6.1.176，共用 fd + null trim）**

| Payload | none QPS | sync QPS | kprobe QPS | kprobe vs sync |
| ------- | -------: | -------: | ---------: | -------------: |
| 64B     |   26,994 |   19,299 |     26,531 |         +37.5% |
| 128B    |   22,964 |   16,406 |     26,272 |         +60.1% |
| 256B    |   26,850 |   18,864 |     24,597 |         +30.4% |
| 512B    |   26,043 |   16,874 |     22,481 |         +33.2% |
| 1024B   |   25,261 |   12,557 |     20,705 |         +64.9% |
| 2048B   |   20,752 |   17,830 |     26,577 |         +49.1% |
| 4096B   |   27,295 |   15,517 |     25,564 |         +64.7% |

> 跨机 kprobe ≈ none（异步转发不阻塞主 echo 路径），sync 因网络 `write(slave)` 阻塞大幅慢于 none。
